...
object ModMessageLang {
	...
	fun add(provider: ModLanguageProvider) {
		...
		provider.add(ENDER_BRIDGE_HIT_BLOCK, "Ender Bridge stopped searching because it hit a %s at %d %d %d.")
		provider.add(REDSTONE_TOOL_BASE_SET, "Redstone Tool linked to the %s at %d %d %d.")
		provider.add(REDSTONE_TOOL_INVALID_BASE_BLOCK, "Cannot link as no base block is set.")
		provider.add(REDSTONE_TOOL_WRONG_DIMENSION, "Cannot link as base %s is in a different dimension.")
		provider.add(REDSTONE_TOOL_UNLOADED, "Cannot link as base %s is in an unloaded chunk.")
		provider.add(REDSTONE_TOOL_BASE_NOT_LINKABLE, "Cannot link as base %s was replaced with a %s.")
		provider.add(REDSTONE_TOOL_LINKED, "Linked the %s at %d %d %d to the %s at %d %d %d.")
		provider.add(FLUID_FALL_DEATH_BOOT, "%s splattered against the surface of %s because they were wearing %s")
		provider.add(FLUID_FALL_DEATH_GENERIC, "%s splattered against the surface of %s because they could walk on it")
		provider.add(ILLUMINATOR_ALREADY_PRESENT, "This chunk already has a Spectre Illuminator!")
		provider.add(FE_RATIO, "%s FE / %s FE")
		provider.add(ADVANCED_ITEM_COLLECTOR_X_RADIUS, "X Radius: %d")
		provider.add(ADVANCED_ITEM_COLLECTOR_Y_RADIUS, "Y Radius: %d")
		provider.add(ADVANCED_ITEM_COLLECTOR_Z_RADIUS, "Z Radius: %d")
		provider.add(ENDER_MAILBOX_NOT_OWNER, "You are not the owner of this Ender Mailbox.")
		provider.add(ENDER_LETTER_EMPTY, "Your letter is empty!")
		provider.add(ENDER_LETTER_ALREADY_SENT, "This letter has already been sent! You can't send it again.")
		provider.add(ENDER_LETTER_NO_RECIPIENT, "This letter has no recipient")
		provider.add(ENDER_LETTER_RECIPIENT_NOT_ONLINE, "%s of this letter is not online")
		provider.add(ENDER_LETTER_RECIPIENT_NO_ROOM, "%s has no room for your letter")
		provider.add(FIREPLACE_NO_NAME, "Nameless fireplace")
		provider.add(FIREPLACE_NAME, "Fireplace: %s")
		provider.add(FIREPLACE_BROKEN, "Bugged fireplace; please break and replace it.")
		provider.add(COMMAND_LEVEL_NOT_FOUND, "Could not find level \"%s\"")
		provider.add(FIREPLACE_NOT_FOUND, "Could not find fireplace named \"%s\"")
		provider.add(FIREPLACES_IN_DIMENSION, "Fireplaces in %s: %d")
		provider.add(FIREPLACE_LIST_ENTRY, "- \"%s\" at %d %d %d")
