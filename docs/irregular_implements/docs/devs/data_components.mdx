...
[Divining Rods](@irregular_implements:divining_rod) use the data component `irregular_implements:divine_blocks`, which takes a block tag. While holding it in either hand, blocks nearby with that tag will glow through walls.
